...
public class ImportExcel {
	 ...
	 * @throws RpcException 
	 */
	public <E> List<E> getDataList(Class<E> cls, int... groups) throws InstantiationException, IllegalAccessException, RpcException{
			...
			for (Object[] os : annotationList){
				...
				if (val != null){
					...
					if (StringUtils.isNotBlank(ef.dictType())){
						JsSysDictData dictDtl = baseCommonApi.getDictByKeyName(0, ef.dictType(), val.toString());
						val = (dictDtl == null ? "" : dictDtl.getDictValue());
	...
	public static void main(String[] args) throws Throwable {
		...
		ImportExcel ei = new ImportExcel("E:\\左键\\文档\\goods_template.xlsx", 1);
