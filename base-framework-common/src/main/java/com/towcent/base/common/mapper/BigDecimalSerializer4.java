 ...
 * @Description: 将json格式化时, 按最小标度输出小数位, 最多四个小数位<br>
 * <code>
 * 0.00  -->  0          <br>
 * 20.10 -->  20.1       <br>
 * 20.12 -->  20.12      <br>
...
//				return;
//			}
//			v = value.setScale(2, RoundingMode.HALF_UP);
//			if (v.doubleValue() == value.doubleValue()) {
//				gen.writeObject(v);
//				return;
//			}
//			v = value.setScale(3, RoundingMode.HALF_UP);
//			if (v.doubleValue() == value.doubleValue()) {
//				gen.writeObject(v);
//				return;
//			}
			BigDecimal v = value.setScale(4, HALF_UP);
			gen.writeObject(v.toString());
			return;
		}
		gen.writeObject(value.setScale(4, HALF_UP));
	}
