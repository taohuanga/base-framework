 ...
 * @version 0.1.0 
 */
public class BeanPropertyGreaterThanPredicate extends CustomPredicate {
	...
	public BeanPropertyGreaterThanPredicate(String propertyName, Object propertyValue) {
		this(propertyName, propertyValue, CompareType.INTEGER);
	}
	
	public BeanPropertyGreaterThanPredicate(String propertyName, Object propertyValue, CompareType compareType) {
