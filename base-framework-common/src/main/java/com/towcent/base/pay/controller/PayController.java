...
package com.towcent.base.pay.controller;
...
import com.towcent.base.pay.request.QueryOrder;
...
public class PayController {
    ...
    public Map<String, Object> secondaryInterface(QueryOrder order) {
        ...
        return (Map<String, Object>) payResponse.getService().secondaryInterface(order.getTradeNoOrBillDate(), order.getOutTradeNoBillType(), type, new Callback<Map<String, Object>>() {
            @Override
