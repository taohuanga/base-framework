...
public enum PayType implements BasePayType {
    ...
    aliPay{
         ...
         */
        @Override
        public PayService getPayService(PayAccount apyAccount) {
            ...
            aliPayConfigStorage.setMsgType(apyAccount.getMsgType2());
            aliPayConfigStorage.setInputCharset(apyAccount.getInputCharset());
            aliPayConfigStorage.setTest(apyAccount.getIsTest());
        ...
        public PayService getPayService(PayAccount apyAccount) {
            ...
            wxPayConfigStorage.setMsgType(apyAccount.getMsgType2());
            wxPayConfigStorage.setInputCharset(apyAccount.getInputCharset());
            wxPayConfigStorage.setTest(apyAccount.getIsTest());
...
//            wxPayConfigStorage.setReturnUrl(apyAccount.getReturnUrl());
    ...
    public abstract PayService getPayService(PayAccount apyAccount);
